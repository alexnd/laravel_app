...
var alert_button,dropdown,navbarToggle, navbar, btn, sideBar, sideBarHideBtn;
...
function initUI() {
    // get the close btn
    alert_button = document.getElementsByClassName('alert-btn-close');
...
// work with sidebar
    btn     = document.getElementById('sliderBtn');
